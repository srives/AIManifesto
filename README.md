...
> This site is better than official Anthropic docs at **translation, framing, analogies, and self-testing**. Official docs are better at freshness, exact product behavior, install paths, and reference completeness. This site's role is **augmentation, not replacement**. Use both.
...
This guide teaches that architecture to working developers. No fluff. No hype. Real analogies from real software engineering.

## What's Inside

| Tab | What It Is | Time |
|-----|-----------|------|
| **The Manifesto** | 16 chapters covering every concept in Claude Code's architecture | 60-75 min |
| **First 15 Minutes** | Task-first walkthrough: open terminal, ask for overview, make a change, run tests | 15 min hands-on |
| **First Session Quiz** | 10 scenario-based questions on your first real session | 5-8 min |
...
| **Practitioner's Guide** | How to actually build software with AI and not collapse at version 5 | 30-40 min |
...
**Total if you read and quiz everything: ~3.5 hours**
...
```
git clone https://github.com/srives/AIManifesto.git
start AIManifesto/index.html
```

No build step. No server. No npm. No dependencies. Just open the HTML file.
